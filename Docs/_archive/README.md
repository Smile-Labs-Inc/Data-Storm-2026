...
| `smil_labs_final_report_v1.md` | early v1 narrative; cites "Tobit Type-I MLE" (no `src/modeling/tobit.py` exists) and median-uplift `1.18x` (canonical: `1.250x`). Archived in R7 per council R5 N5.5 / R6 N6.1. |
